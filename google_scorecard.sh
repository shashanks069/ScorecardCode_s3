...
RAW_S3_PATH="s3://${BUCKET_NAME}/data/${FEED_NAME}/download"
echo ${RAW_S3_PATH}
...
do
        ...
        CN_TIME=`aws s3 ls ${RAW_S3_PATH}/day=${DAY}/ | awk 'FNR==1 {print $1,$2}'`
        CN_DATE=`aws s3 ls ${RAW_S3_PATH}/day=${DAY}/ | awk 'FNR==1 {print $1}'`
